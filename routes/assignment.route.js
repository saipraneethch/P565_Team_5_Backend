...
import { getAssignments, addAssignment, deleteAssignment , updateAssignment, submitAssignment, getSubmittedFiles, fetchAllStudents,getStudentSubmittedAssignment, submitFeedbackGrade, getAssignmentGrades, submitUserFeedback} from '../controllers/assignment.contoller.js';
...
assignmentRouter.post('/submit-user-feedback', submitUserFeedback);


assignmentRouter.post('/get-assignment-grades', getAssignmentGrades);
